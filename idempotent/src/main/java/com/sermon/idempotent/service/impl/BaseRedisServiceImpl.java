 ...
 */
package com.sermon.idempotent.service.impl;

import com.sermon.idempotent.service.IBaseRedisService;
...
//    @Resource(name = "redisTemplate")
     ...
     */
    @Override
    public RedisSerializer<String> getRedisMasterSerializer() {
     ...
     */
    @Override
    public RedisSerializer<String> getRedisSlaveSerializer() {
        RedisSerializer<String> redisSerializer = getredisTemplate().getStringSerializer();
        return redisSerializer;
    }
}